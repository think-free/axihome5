            ...
            <div style={MainAreaStyle.main}>
                <div style={MainAreaStyle.loginBox}>
                    <div style={MainAreaStyle.loginInputs}>
                        ...
                        <span><img style={MainAreaStyle.image} src="/login/static/password.png" width="18" height="20" draggable="false"/> <input key="password" style={mainStyle.inputStyle} type="password" value={this.state.password} onChange={this.passwordChanged} onBlur={this.passwordChanged} onKeyPress={this.keyPressed}/></span>
                    </div>
                </div>
            </div>
        )
